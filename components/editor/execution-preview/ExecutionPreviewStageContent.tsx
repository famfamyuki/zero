...
interface ExecutionPreviewStageContentProps {
  state: ExecutionPreviewState;
  isRefreshing: boolean;
  lang: Language;
  notice: string | null;
  onRetry: () => void;
  onLocate: (type: ExecutionPreviewTargetType, id: string | undefined, source: ExecutionPreviewLocateSource) => boolean;
  onOpenValidation: () => void;
}

export function ExecutionPreviewStageContent({ state, isRefreshing, lang, notice, onRetry, onLocate, onOpenValidation }: ExecutionPreviewStageContentProps) {
