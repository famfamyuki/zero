...
export function ReadinessEntryButton({ status, lang, isOpen, compact = false, onActivate }: { status: ReadinessStatus; lang: Language; isOpen: boolean; compact?: boolean; onActivate: (trigger: HTMLButtonElement) => void }) {
