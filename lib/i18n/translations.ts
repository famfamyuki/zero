...
export const translations = {
  en: {
    ...
    outputFormatJson: 'Validated JSON (Pydantic)',
    outputFormatHelp: 'JSON adds a Pydantic schema to the generated task.',
  ...
  ja: {
    ...
    outputFormatJson: '検証済みJSON（Pydantic）',
    outputFormatHelp: 'JSONを選ぶと、生成されるTaskへPydanticスキーマを接続します。',
