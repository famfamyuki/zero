...
export class OpenAIArchitectureReviewer implements ArchitectureReviewer {
  ...
  constructor(private readonly client=new OpenAI({apiKey:process.env.OPENAI_API_KEY}),readonly model=process.env.ARCHITECTURE_REVIEW_MODEL||'gpt-5.6-sol'){}
