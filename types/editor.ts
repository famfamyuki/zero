...
export type ValidationCode =
  ...
  | 'NODE_ENTRY_INVALID' | 'NODE_TYPE_INVALID' | 'NODE_POSITION_INVALID' | 'NODE_DATA_INVALID' | 'EDGE_ENTRY_INVALID' | 'EDGE_ID_INVALID'
  | 'EDGE_SOURCE_INVALID' | 'EDGE_TARGET_INVALID' | 'EDGE_HANDLE_INVALID' | 'CREW_NAME_INVALID'
  | 'CREW_CONFIG_INVALID' | 'CREW_PROCESS_INVALID' | 'CREW_VERBOSE_INVALID' | 'CREW_MEMORY_INVALID' | 'AGENT_ROLE_MISSING'
